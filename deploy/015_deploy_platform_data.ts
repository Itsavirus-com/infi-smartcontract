import { PlatformData__factory } from '@project/contracts/typechain';
...
type DeployArgs = Parameters<PlatformData__factory['deploy']>;
...
func.tags = ['PlatformData']; // This sets up a tag so you can execute the script on its own (and its dependencies).
