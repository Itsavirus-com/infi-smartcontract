import { CoverGateway__factory } from '@project/contracts/typechain';
...
type DeployArgs = Parameters<CoverGateway__factory['deploy']>;

const NAME = 'CoverGateway';
...
func.tags = ['CoverGateway']; // This sets up a tag so you can execute the script on its own (and its dependencies).
// func.dependencies = ['CoverData'];
