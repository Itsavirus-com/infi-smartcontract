import { CollectiveClaimGateway__factory } from '@project/contracts/typechain';
...
type DeployArgs = Parameters<CollectiveClaimGateway__factory['deploy']>;

const NAME = 'CollectiveClaimGateway';
...
func.tags = ['CollectiveClaimGateway']; // This sets up a tag so you can execute the script on its own (and its dependencies).
