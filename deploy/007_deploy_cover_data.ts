import { CoverData__factory } from '@project/contracts/typechain';
...
type DeployArgs = Parameters<CoverData__factory['deploy']>;

const NAME = 'CoverData';
...
func.tags = ['CoverData']; // This sets up a tag so you can execute the script on its own (and its dependencies).
// func.dependencies = [];
