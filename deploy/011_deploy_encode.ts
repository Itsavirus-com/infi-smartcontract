import { Encode__factory } from '@project/contracts/typechain';
...
type DeployArgs = Parameters<Encode__factory['deploy']>;
...
func.tags = ['Encode']; // This sets up a tag so you can execute the script on its own (and its dependencies).
